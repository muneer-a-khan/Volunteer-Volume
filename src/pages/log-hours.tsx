            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700">
                  <p>
                    Only use this form to log hours that weren't tracked through the check-in/check-out system. Hours logged manually require approval from an administrator.
                  </p>
                </div>
              </div>
            </div>
