      ...
      <div className="relative bg-cover bg-center h-96 flex items-center justify-start px-10 text-white" 
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 w-full">
          ...
          <div className="mt-5 flex gap-4">
            <Link href="/dashboard">
              <Button size="xl" className="bg-primary hover:bg-primary/90">Dashboard</Button>
            </Link>
            <Link href="/shifts">
              <Button variant="outline" size="xl" className="bg-white text-primary border-white hover:bg-white/90">View Shifts</Button>
            </Link>
          </div>
        </div>
      </div>
